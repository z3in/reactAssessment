    ...
    */
    ...
    return (
        <div>
            ...
            Strength : <input type="number" name="str" onChange={changeFighter1} style={{marginBottom:"10px"}} max="30" placeholder="Strength"/>
            Vitality : <input type="number" name="agi" onChange={changeFighter1} style={{marginBottom:"10px"}}  max="30" placeholder="Vitality"/>
            Agility : <input type="number" name="vit" onChange={changeFighter1} style={{marginBottom:"10px"}} max="30" placeholder="Agility"/>
            ...
            Strength : <input type="number" name="str" onChange={changeFighter2} style={{marginBottom:"10px"}} placeholder="Strength"/>
            Vitality : <input type="number" name="agi" onChange={changeFighter2} style={{marginBottom:"10px"}} placeholder="Vitality"/>
            Agility : <input type="number" name="vit" onChange={changeFighter2} style={{marginBottom:"10px"}} max="30" placeholder="Agility"/>
